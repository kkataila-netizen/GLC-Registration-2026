...
(() => {
  ...
  function buildAgenda(reg) {
    ...
    if (Array.isArray(reg.sessions) && reg.sessions.includes('Tue: Banyan Fundamentals Workshop')) {
      tue.push({ tag: 'Session', time: '12:00 – 5:00 PM', title: 'Banyan Operating System (BOS) Fundamentals' });
    }
    if (reg.welcomeReception) {
      tue.push({ tag: 'Reception', time: '6:00 – 9:00 PM', title: 'Welcome Reception' });
    }
