...
(() => {
  ...
  const AGENDA = [
    ...
    { day: 1, sort: 975,  tag: 'Event', time: '4:15 – 4:30 PM', title: 'Group Photo', who: 'Everyone', loc: 'Canadian Room · Convention Floor', audience: all },
    { day: 1, sort: 1005, tag: 'Breakout', time: '4:45 – 5:45 PM', title: 'Operating Group Breakout: Darren', loc: 'Confederation 5 · Mezzanine Floor', audience: r => inOpGroup(r, 'Darren') },
    { day: 1, sort: 1005, tag: 'Breakout', time: '4:45 – 5:45 PM', title: 'Operating Group Breakout: Arun', loc: 'Tudor 7 · Mezzanine Floor', audience: r => inOpGroup(r, 'Arun') },
    ...
    { day: 2, sort: 480,  tag: 'Activity', time: '8:00 – 8:25 AM', title: 'Yoga & Puppies — Session #1', loc: 'Tudor 7 · Mezzanine Floor',
      details: 'Meeting time: 7:55 AM · Host: Zuzu Wilson 416-356-2642 · Attire: yoga clothes / activewear · Please wear socks for the puppy yoga sessions', audience: r => r.morningConnection === 'yoga1' },
    { day: 2, sort: 510,  tag: 'Activity', time: '8:30 – 9:00 AM', title: 'Yoga & Puppies — Session #2', loc: 'Tudor 7 · Mezzanine Floor',
      details: 'Meeting time: 8:30 AM · Host: Zuzu Wilson 416-356-2642 · Attire: yoga clothes / activewear · Please wear socks for the puppy yoga sessions', audience: r => r.morningConnection === 'yoga2' },
